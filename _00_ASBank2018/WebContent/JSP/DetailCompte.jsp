...
<p>
	...
	<s:else>
		Solde : <span class="soldeNegatif"><s:property value="compte.solde" /></span>
		<br />
	</s:else>
	<s:if test="%{compte.className == \"CompteAvecDecouvert\"}">
		Découvert maximal autorisé : <s:property value="compte.decouvertAutorise" />
	</s:if>
	<br />
</p>
